...
public class RestaurantController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<Restaurant> getByrestaurantId(@RequestHeader String authorization, @PathVariable Long id) throws RestaurantNotFoundException{
		logger.debug("In get order by id method, calling service to get Order by ID");
		Optional<Restaurant> restaurant = restaurantService.getByrestaurantId(id);
		if(restaurant.isPresent()) {
			...
			throw new RestaurantNotFoundException("No result found for specified inputs");
		}
	}
